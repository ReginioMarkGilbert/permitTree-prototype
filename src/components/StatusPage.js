...
const StatusPage = ({ applicationId }) => {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch('https://permittree-api.netlify.app/api/applications');
            if (response.ok) {
    ...
    const handleUpdateSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`https://permittree-api.netlify.app/api/applications/${selectedApplication._id}`, {
                method: 'PUT',
                headers: {
    ...
    const handleDeleteClick = async (id) => {
        try {
            const response = await fetch(`https://permittree-api.netlify.app/api/applications/${id}`, {
                method: 'DELETE',
            });
